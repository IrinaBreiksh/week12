...
const makeSixteen = () => {
	const str = 'JavaScript';
	resultSixteen.textContent = str.slice(3);
};
...
const makeSeventeen = () => {
	const str = 'JavaScript';
	resultSeventeen.textContent = str.slice(3,7);
};
...
const makeNineteen = () => {
	const str = 'Hello, world!';
	resultNineteen.textContent = str.substr(3,6);
};
...
const makeTwentyOne = () => {
	resultTwentyOne.textContent = Math.floor(Math.random()*10)+1;
};
...
const makeTwentySeven = () => {
	...
	resultTwentySeven.textContent = Math.floor(rand);
};
